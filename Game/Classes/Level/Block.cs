...
namespace ChendiAdventures
{
    public class Block : Entity
    {
        ...
        public static Sound sShatter = new Sound(new SoundBuffer(@"sfx/shatter.wav")) { Volume = 20 };
        ...
        public void BlockUpdate(Level level)
        {
            ...
            if (Type == BlockType.DestroyedStone)
            {
                if (DefaultTimer.ElapsedTime.AsSeconds() > 15)
                {
